<!-- $Id: readme.md 2266 2026-03-23 14:20:46Z sow $ -->
# prg0004_WebSwitch
...
HOST program 'prg0004_WebSwitch.py' access web page. To inform web switch status for MapperZeroAir, 'prg0004_WebSwitch.py' writes the status into $7FF8 on 32KByte PRG-ROM then issue IRQ. Therefore, 'prg0004_WebSwitch.asm' disables NMI and jumps to WRAM, then wait IRQ. Because CPU will access to PRG-ROM when NMI is occured, NMI must be disabled. Writing the web switch status to PRG-ROM is done safely because 6502 is running on WRAM without any PRG-ROM access.
