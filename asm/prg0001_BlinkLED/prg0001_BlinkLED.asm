; $Id: prg0001_BlinkLED.asm 1547 2023-12-15 14:04:28Z sow $

; CONFIG
; ----
FILL_CHR_ROM_EN EQU $01 ; $00...don't fill $01...fill CHR-ROM
USE_IRQ_LOADER  EQU $01 ; $00...don't use  $01...use
DIMMING_LED_EN  EQU $00 ; $00...Blink LED  $01...Dimming LED
...
LED_PORT         EQU $6000 ; LED is assigned to bit 0
...
MAIN_CLOSING:
    ...
    cli
MAIN_LOOP:
    .if (DIMMING_LED_EN) ; DIMMING_LED_EN
    jsr DIMMING_LED      ; DIMMING_LED_EN
    .else                ; DIMMING_LED_EN
    jsr BLINK_LED
    .endif               ; DIMMING_LED_EN
MAIN_LOOP_END:
    jmp MAIN_LOOP

BLINK_LED:               ; BLINK_LED
    jsr WAIT_NEXT_VBLANK ; BLINK_LED
    inc <WORK            ; BLINK_LED
    lda <WORK            ; BLINK_LED
    lsr a                ; BLINK_LED
    lsr a                ; BLINK_LED
    ...
    lsr a                ; BLINK_LED
    and #$01             ; BLINK_LED
	sta LED_PORT         ; BLINK_LED
	rts                  ; BLINK_LED

FREQ_A EQU $C0        ; DIMMING_LED
FREQ_B EQU $C1        ; DIMMING_LED
DIMMING_LED:          ; DIMMING_LED
    inc <WORK_L       ; DIMMING_LED
    lda <WORK_L       ; DIMMING_LED
    cmp #FREQ_A       ; DIMMING_LED
    bne DIMMING_LED_1 ; DIMMING_LED
    lda #$00          ; DIMMING_LED
    sta <WORK_L       ; DIMMING_LED
DIMMING_LED_1:        ; DIMMING_LED
    inc <WORK_H       ; DIMMING_LED
    lda <WORK_H       ; DIMMING_LED
    cmp #FREQ_B       ; DIMMING_LED
    bne DIMMING_LED_2 ; DIMMING_LED
    lda #$00          ; DIMMING_LED
    sta <WORK_H       ; DIMMING_LED
DIMMING_LED_2:        ; DIMMING_LED
    lda <WORK_L       ; DIMMING_LED
    sec               ; DIMMING_LED
    sbc #(FREQ_A/2)   ; DIMMING_LED
    bmi DIMMING_LED_3 ; DIMMING_LED
    lda <WORK_H       ; DIMMING_LED
    sec               ; DIMMING_LED
    sbc #(FREQ_B/2)   ; DIMMING_LED
    bmi DIMMING_LED_3 ; DIMMING_LED
    and #$01          ; DIMMING_LED
	sta LED_PORT      ; DIMMING_LED
	rts               ; DIMMING_LED
DIMMING_LED_3:        ; DIMMING_LED
    and #$00          ; DIMMING_LED
	sta LED_PORT      ; DIMMING_LED
	rts               ; DIMMING_LED
...
MESSAGE:
    .if (DIMMING_LED_EN)  ; DIMMING_LED_EN
    db "Dimming LED", $00 ; DIMMING_LED_EN
    .else                 ; DIMMING_LED_EN
    db "Blink LED", $00
    .endif                ; DIMMING_LED_EN
